...
//
//    // 생성자 주입
//    public StorageService(StorageRepository storageRepository, FacePictureService facePictureService) {
//        this.storageRepository = storageRepository;
//        this.facePictureService = facePictureService;
//    }
//
//    @Value("${jwt.secret.key}")
//    private String jwtSecretKey;
//
//    public String uploadImage(String authorization, MultipartFile file, Integer forehead, Integer leftCheek, Integer rightCheek, Integer chin) throws IOException {
