...
public class ClinicMemberController {
    ...
    @GetMapping("/info")
    public ResponseEntity<ClinicMemberSignInResponseDto> getClinicMember(@RequestParam String clinicEmail) throws Exception {
        ClinicMemberSignInResponseDto clinicMember = clinicMemberService.getClinicMemberInfo(clinicEmail);
        return ResponseEntity.ok(clinicMember);
    }
