...
public class SignInController {
    ...
    public ResponseEntity<SignInResponseDto> getMemberInfo(@RequestParam String email) throws Exception {
        return new ResponseEntity<>(signInService.getMemberInfo(email), HttpStatus.OK);
    }
}
